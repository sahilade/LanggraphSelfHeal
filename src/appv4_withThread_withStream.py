...
def createAPIParam(Query: str):
    ...
    FilterPrompt=f""" 
        You are ServiceNow system Expert. You know everything about ServiceNow OOB tables and APIs. 
        ...
        1. Identify the service now table name based on the query from your knowledge or below examples.
        ...
        /tablename? followed by param filters and fields and limit

        This format should be copy paste ready
        ...
        Tables for example (not limited to ):
        sys_rest_message
        incident
        kb_knowledge
        sys_journal_field 
    ...
    for m in messages:
        ...
        if isinstance(m, HumanMessage) or (isinstance(m,BaseMessage) and m.type=="human"):
            ...
            content = json.dumps({
                    ...
                    "name": m.name,
                    "content": "Error in tool - Highlight to User " + m.content
                })
